...
(1, 'siteurl', 'http://hashmiserver/theblog/', 'yes'),
(2, 'home', 'http://hashmiserver/theblog/', 'yes'),
(3, 'blogname', 'The Blog', 'yes'),
(4, 'blogdescription', '', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'developerfaraz@outlook.com', 'yes'),
...
(127, '_site_transient_theme_roots', 'a:1:{s:7:\"theblog\";s:7:\"/themes\";}', 'no'),
...
DROP TABLE IF EXISTS `blog_termmeta`;
...
(1, 'adminfarazhashmi', '$P$BtNHwFkKEfdYsxVwyH.SCF.1Mu/bcQ.', 'adminfarazhashmi', 'developerfaraz@outlook.com', 'http://hashmiserver/theblog/', '2023-11-22 12:26:42', '', 0, 'adminfarazhashmi');
